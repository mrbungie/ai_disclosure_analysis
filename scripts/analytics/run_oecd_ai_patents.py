...
Downloads the firm-year panel and saves locally to data/processed/ and BigQuery.
"""
...
OUT_PARQUET = REPO_ROOT / "data" / "processed" / "sp500_firm_year_ai_patents_oecd2025.parquet"
OUT_CSV = REPO_ROOT / "data" / "processed" / "sp500_firm_year_ai_patents_oecd2025.csv"
