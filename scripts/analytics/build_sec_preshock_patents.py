...
BASE_SQL = REPO_ROOT / "scripts" / "analytics" / "oecd_ai_patents_query.sql"
...
def main():
    ...
    sql = build_query()
    out_sql = REPO_ROOT / "scripts" / "analytics" / "preshock_patents_query.sql"
    ...
    out_parquet = REPO_ROOT / "data" / "processed" / "sp500_firm_preshock_patent_capacity.parquet"
