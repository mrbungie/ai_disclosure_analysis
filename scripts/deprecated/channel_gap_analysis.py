"""DEPRECATED (G-H2): split into scripts/gold/channel_gap/build_channel_gap_cells.py
(cells only, no regressions) and scripts/analytics/channel_gap/channel_gap_did.py
(the DiD/event-study/robustness/notorious-cases/cross-check estimation).
Also dropped the dead read of the deprecated scripts/deprecated/build_segments.py
output (firm_segments.parquet). Not run by anything; kept for history.
