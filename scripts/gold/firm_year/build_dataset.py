"""The firm_year dataset: spines/firm_year/firm_year left-joined with every covariate and target
...
Output: datasets/firm_year/firm_year.
"""
...
def main() -> None:
    dataset, collisions = join_families("firm_year")
    report("firm_year", dataset, collisions)
    L.write_gold("datasets", "firm_year", "firm_year", dataset, builder="scripts/gold/firm_year/build_dataset.py",
                 inputs=inputs("firm_year"), extra={"collisions": collisions})
