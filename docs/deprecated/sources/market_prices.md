...
`scripts/raw_ingestion/market/01_collect_market_data.py`'s own docstring for the
...
`scripts/raw_ingestion/market/01_collect_market_data.py`. Universe:
...
## Chile — `scripts/raw_ingestion/cl/03_fetch_market_data.py`
