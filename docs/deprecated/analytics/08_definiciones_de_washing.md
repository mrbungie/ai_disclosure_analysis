...
Producido por `scripts/gold/washing/washing_score.py` y validado por
`scripts/analytics/washing/validate_washing_score.py`. Determinístico, sin LLM.
...
### Qué actividad hay detrás del exceso
...
`scripts/analytics/appendix/earnings_calls_analysis.py`) y el diseño por canal está en
