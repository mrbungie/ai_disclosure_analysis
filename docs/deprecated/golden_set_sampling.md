...
ajustar el prefiltro** (`scripts/bronze/ai_prefilter.py`): elegir su umbral, medir
precisión y recall por categoría, y comparar variantes de anchors.

Implementación: `scripts/bronze/golden_set.py`.
...
`scripts/raw_ingestion/us/sector_map.py`:
