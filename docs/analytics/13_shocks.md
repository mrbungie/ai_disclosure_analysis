...
Por segmento de divulgación (`11_segmentacion.md`), cambio post en promocionales
por 1.000 párrafos: adoptantes con gobernanza +0,40, desplegadores de producto
+0,92, listadores de riesgo +0,32, todos con p<0,001 y todos con la misma
advertencia: es la curva, no el corte.
