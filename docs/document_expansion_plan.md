...
2. `scripts/us/section_segmenter.py` (o un segmentador nuevo si el 8-K
...
`scripts/us/00_build_firm_universe.py` (ver
`scripts/us/docs/sp500_2021_universe_provenance.md`, que ya usa
