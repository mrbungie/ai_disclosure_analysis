...
- [ ] **1. §1.5 (o nuevo §1.6) — Metodología + expected outcome por RQ.** Agregar ½
...
- [ ] **9. §1.5 (RQs) — eliminar las cuatro colas "Derived from X theory…".**
...
- [ ] **15. §6.2 — sacar "martingale processes" y la justificación técnica.** Ecuación
      ...
      Máxima**
- [ ] **16. §7.2.1 (W + Simonian) — reducir a dos frases.** "D y S determinan el
      cuadrante; W prioriza revisión dentro de él y no es un fraud label." +
      "Initial public-disclosure screen, not a substitute for technical due diligence."
      Nada más. **Original — Prioridad: Máxima**
...
- [ ] **19. §7.1 — Table 15 + solo Microsoft y Welltower en prosa.** JPM/GS y Apple
      quedan solo en la tabla. **Original — Prioridad: Muy alta**
...
- [ ] **22. Apertura Cap. 6 — a la mitad.** "Analyses are exploratory, common
      specifications plus FDR correction." Sin Tukey/Gelman-Loken en el cuerpo.
...
- [ ] **26. §2.2 (KDD/CRISP-DM) — cortar el párrafo a máximo una frase.** **Original —
      Prioridad: Alta**
...
- [ ] **37. §6.4 — mantener el null result + multiplicity correction.** Sacar los
      p-values listados uno a uno. **Original — Prioridad: Alta**
- [ ] **38. §6.5.1 — horizonte a una frase.** Sector-exclusion y posture-switchers →
      Appendix E. **Original — Prioridad: Alta**
- [ ] **39. Recortes menores varios** — §2.3, §2.5, §3.1, §3.2, §4.3, §4.4, §4.6, §4.7,
      apertura §5, §5.5, §6.6, §8.2: threshold/features al apéndice, distribuciones al
      apéndice, "never input to clustering" decirlo una sola vez, seasonal factor a
      nota al pie, referencia a Blades et al. fuera del cuerpo, etc. Ver detalle caso a
      caso al tocar cada sección. **Original — Prioridad: Media**
