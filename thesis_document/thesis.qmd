...
Beyond the four primary quadrants in @tbl-screening-matrix, two distributional cuts establish prioritization rules for investigative triage using $W$ as a relative ranking rather than an absolute diagnosis: within the Investigate quadrant, `{python} scr_tail` FY2026 firm-years sit above the 95th percentile of $W$ in the full 2021–2026 panel (Extreme Decoupling). For these firms, the immediate diligence task is to read the specific ungrounded claims driving narrative volume and locate factual backing in technical documentation or product releases. Conversely, `{python} scr_neg` disclosers exhibit negative $W$ (substance rank exceeding narrative volume rank, anchoring the Explore cell), where diligence focuses on cataloging deployed production tools that management has chosen not to promote externally.

**Step 3, Venue.** A cross-cutting screen, Reconcile, prioritizes cross-venue verification among the `{python} scr_n_dual` issuers with both a 2026 earnings call and a 2026 filing. Of these, `{python} scr_n_gap` display an oral-minus-filing promotional gap exceeding 1.5 standard deviations above the 2026 mean ($Z_{\text{gap}} > 1.5$). This threshold prioritizes claims for immediate cross-channel auditing: analysts must compare oral earnings-call assertions against the signed Form 10-K to determine whether management walked back or omitted unsubstantiated commercial claims when under formal statutory liability.
...
For corporate issuers, disclosure governance means keeping external communication matched to the role AI actually plays inside the business. Where AI is a core differentiator, that means sustaining evidentiary density and reporting falsifiable milestones; where it is peripheral, it means resisting promotional inflation, which costs credibility with investors long before it attracts a comment letter. Across all postures, draft conference-call remarks are worth reconciling against the signed Form 10-K before they are delivered, since the divergence between the two is visible to anyone who reads them side by side.
...
Corporate AI disclosure diffused across almost the entire market -- from one third of S&P 500 firms in 2021 to over nine in ten by 2025-2026 -- while the concrete evidence behind each disclosed activity thinned over the same period, so companies talk about AI more than they used to, but each mention now carries less proof. Firms sort into three stable, industry-shaped ways of communicating about AI, and that communication style tracks what firms actually report doing, not just how much they say: at equal disclosure volume, some styles report several times as many concrete AI activities as others. Promotional claims run further ahead of the evidence behind them on earnings calls than in statutory filings, that gap between talk and evidence is a stable trait of a firm rather than a one-off, and the one company observed under direct SEC scrutiny for its AI disclosures narrowed that gap rather than disputing it. Market outcomes, however, line up primarily with narrative volume and disclosure posture rather than with operational substance: cumulative disclosure volume predicts larger size, higher systematic risk, and attenuated downside crash risk, while reallocating posture toward Governance associates with lower systematic risk and larger size (both surviving multiple-testing correction). In contrast, verifiable substance adds nothing measurable to what narrative volume already explains. Taken together, the evidence indicates that disclosure posture and grounded substance capture real operational differences across firms, but market pricing reflects narrative volume and governance framing rather than verifiable operational execution.

## Managerial implications

The measurement architecture built for this thesis is also an operational monitoring tool that issuers, investors, and boards can apply directly, rather than solely an academic instrument. It is built for the two primary market counterparties—the company drafting disclosures and the investor evaluating them—with the regulator operating as the enforcement backstop for discrepancies.

- **Companies (management and boards)**: Issuers should avoid managing AI communication as a narrative volume target. Instead, disclosure committees and boards should maintain an auditable internal inventory of AI initiatives—tracking accountable owners, maturity stage, technical provenance, and evidentiary backing across disclosure venues. Boards gain substantial oversight leverage from verifying cross-venue consistency between oral earnings calls and statutory filings rather than policing generic phrasing, ensuring that external claims reflect verifiable operational capabilities before drawing regulatory inquiry.
- **Investors and analysts**: Due diligence requires separating narrative persistence, disclosed operational activity, and evidentiary grounding before interpreting AI volume as technological capability. The decoupling index ($W$) and cross-venue divergence metrics serve as efficient triage mechanisms to prioritize where to deepen qualitative and technical scrutiny, identifying where promotional rhetoric runs ahead of verifiable execution.

## What the evidence says AI washing is

Three findings, read together, define what AI washing is on this evidence rather than merely restate that it exists. First, it is a continuous, within-firm gap between narrative volume and grounded substance, not a discrete style that a subset of firms adopts: the persistence of the decoupling measure ($W$) across years points to firms sitting at different points along one spectrum, not into a separate class of "washing" firms -- a pattern more consistent with institutional pressure to adopt shared AI vocabulary than with a fixed group of bad actors. Second, it is a fact about information, not about capability: firms disclosed proportionally less concrete evidence per activity as AI became a market-wide topic, which says nothing about whether their underlying AI programs improved or worsened -- claims simply stopped carrying the detail that would let an outsider verify them, the condition signalling theory treats as necessary for a claim to be credible. Third, it filters by venue: while earnings calls carry denser concentrations of quantified metrics and provider citations per thousand words, statutory Form 10-Ks systematically filter out concrete operational details in favor of standardized hazard warnings and high-level strategy framing. AI washing thus manifests not as crude fabrication, but as an asymmetric transmission of operational evidence between communicative channels under differing legal liability.
