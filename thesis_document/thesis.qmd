...
| **5. Supervision & Governance** | Institutionalize board and audit committee oversight of AI risk in proxy statements (DEF 14A) and Item 10. | Board oversight disclosures are associated with lower downside tail risk ($NCSKEW$), the only archetype effect to survive multiplicity correction across the outcome family. |
...
- **Boards and regulators** get more traction from asking for quantified outcomes and call-filing consistency than from policing generic AI language: the one observed instance of direct regulatory scrutiny is consistent with regulatory inquiry narrowing the disclosure gap. Boards and regulators should also treat governance-oriented AI disclosure as more than compliance formality: it is the only disclosure posture in this study associated with lower downside tail risk after multiplicity correction.
