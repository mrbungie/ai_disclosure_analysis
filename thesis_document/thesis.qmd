...
* **Institutional legitimacy and diffusion.** Firms in the same industry come to sound alike. @dimaggio1983 show why: they answer to the same regulators, they copy each other when nobody knows what works yet, and their managers are trained in the same places. The point that matters here is that a phrase can spread through an industry without anything changing in what those firms actually do, so counting how often AI is mentioned measures the pressure to mention it as much as the capability behind it. @meyer1977 make the same case for adopted vocabulary generally -- it buys standing rather than efficiency -- and @suchman1995 sets out how firms manage that standing on purpose. This is why AI language spreads across industries and settles into a few recurring postures, and why this thesis measures substance separately instead of counting mentions. A rising count of AI mentions across a peer group signals industry-wide pressure rather than firm-specific capability, and should not alone move a valuation or lending decision.
...
In December 2023 the SEC warned public companies against overstating what their AI can do: risk and governance framing accelerate over the sample, but neither turns at that date, and both fit a break in early 2023 better than the warning itself (Appendix E).
