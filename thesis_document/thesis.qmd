...
Every provider family named by at least one S&P 500 firm inside its AI disclosure appears in @tbl-c3-vendor-ecosystem, with the literal names it was matched on. The fifteen most-cited families carry the concentration reported in @tbl-vendor-providers; the remainder shows how thin the tail is, and how little of it sits outside the United States.
