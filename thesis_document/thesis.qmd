...
for name, edge in zip([g[0] for g in groups], band_edges):
    ax.text(-0.13, y[edge] + 0.45, name, fontsize=8.0, fontweight="bold", color="#334155",
            ha="left", va="bottom", transform=ax.get_yaxis_transform(which="grid"))
...
ax.legend(fontsize=8.0, loc="lower right", frameon=False, ncol=2)
