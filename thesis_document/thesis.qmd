...
By contrast, the adjacent Arista inquiry—which focused on segment reporting rather than AI capabilities—showed no narrative contraction: claim density rose by `{python} _ad("claim_density")`, tracking peer trends (`{python} _ad("claim_density", "controls_mean")`). This is descriptive case evidence, not causal identification, but the contrast is consistent with the hypothesis that a direct request for evidence on technical capabilities can narrow the gap between narrative and substance: asked to substantiate its claims under statutory liability, Welltower contracted narrative volume and closed its decoupling gap.
