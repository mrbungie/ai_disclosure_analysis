...
Following @gelman2014, these evaluations are exploratory diagnostics, not confirmatory tests: theoretical channels are pre-specified, Benjamini–Hochberg False Discovery Rate corrections address multiple testing, and every regression conditions on the outcome's own predetermined lag.
