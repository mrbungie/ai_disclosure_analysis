...
The segmentation says that Product Deployers devote more of their AI statements to deployment and outcomes; it does not say what they deploy. A second, narrower pass of the language model over the 17,420 paragraphs that carry a firm-subject behavioural frame turns each such statement into a *disclosed AI activity*: the firm performs an action (deploy, develop, integrate, buy or license, partner, invest in infrastructure, hire or train, pilot, scale, measure an outcome, govern, restrict) on an object (a copilot, a fraud model, a data centre) for a function (customer service, software development, underwriting), with a target, a stage, a named provider where there is one, and the strength of the evidence attached (a named product or process, a metric, a vendor, or none). Objects and functions are free text normalised afterwards into families. Each activity is counted once per firm. The pass yields 27,468 activities for 471 of the 510 firms; 48% appear only on earnings calls. These are activities the firm *says* it performs, with the supporting sentences as evidence.

Six in ten activities are deployments and three in four are declared deployed or scaled: the register is one of use, not exploration. But the typical activity is thin. The largest object family, present in 87% of firms, is "AI" with an empty noun ("AI capabilities", "generative AI tools"); a third of activities name no business function; and providers are almost never named: 88% of activities are proprietary or unspecified. What firms say they do, concretely, is in @tbl-concrete.

| Action · object | % of firms | Literal objects, examples |
|---|---:|---|
| deploy · product or service with AI | 54.3 | AI engine, Firefly services, advertising tools |
| deploy · ML or predictive model | 45.7 | machine learning models, AI algorithms |
| deploy · analytics or data platform | 44.3 | AI platform, AI-powered analytics |
| deploy · named product or platform | 41.8 | AIP, AIOps, DSO.ai, Firefly |
| deploy · automation | 38.0 | automation, intelligent automation |
| hire or train · talent | 28.6 | AI talent, workforce |
| develop · product or service | 25.9 | AI-driven software, interconnect products |
| invest · compute and infrastructure | 22.5 | AI infrastructure, data centres, compute capacity |
| deploy · copilot or assistant | 20.4 | Copilot, AI assistant, Agentforce, AI Overviews |
| deploy · compute and infrastructure | 20.2 | AI PC, AI accelerators, AI workloads |
| integrate · product or service | 19.4 | AI into products, AI into offerings |
| develop · ML or predictive model | 19.0 | AI models, machine learning models |
| deploy · vision, robotics or autonomy | 16.7 | autonomous driving software, autonomous database |
| develop · named product or platform | 16.7 | Omniverse, MI350 series, Blackwell |
| deploy · AI agents | 14.5 | AI agents, agentic AI |
| deploy · LLM or foundation model | 13.3 | large language models |
| deploy · search or recommendation | 13.1 | recommendation engine, personalisation engine, search engine |
| measure outcome · financial outcome | 12.5 | AI revenue, productivity savings, cost savings |
| deploy · chatbot | 12.7 | chatbot, conversational AI |
| deploy · security tool | 12.5 | ML-powered firewall, threat graph |
...
With the function attached, the most common things an S&P 500 firm says it does with AI are: deploy an AI product or tool in operations (28% of firms), automate operations (27%), deploy a named product in operations (19%: AIOps, Cortex XSIAM, Mist AI, AIP), run predictive models in operations (18%), put AI into the product itself (15%: full self-driving, Apple Intelligence, cockpits), deploy an AI product for customer service (12.5%: virtual try-on, guest-journey tools), a copilot or assistant for customer service (9.6%), predictive models for marketing (8.4%) and for fraud and risk (7.3%), a recommendation engine for marketing (7.1%), and coding tools (7.1%). On providers, 246 of 510 firms name an external one somewhere: OpenAI/Microsoft in 16.3% of firms (OpenAI, GitHub Copilot, Azure OpenAI), NVIDIA in 9.4%, Google in 6.3%, AWS in 3.9%; Meta, Anthropic, IBM and Salesforce each in about 1%. Another 42.5% name a provider outside those families, often the firm's own branded product (Firefly, Sensei, Mist AI, Kensho, Palantir).

The activity layer gives the segments tangible content (@tbl-activities-seg). Product Deployers *sell* AI: 96% deploy an AI product, 90% a named product or platform, 82% an analytics platform, 61% invest in data centres and compute, 60% ship compute (AI PCs, accelerators), 56% hire AI talent; 90% name a provider and 90% report a figure; the median Deployer has 108 activities. Governance Adopters automate operations (39%), deploy predictive models (46%) and analytics (45%) mostly inward (58% of their activities are internal), in fraud, risk and forecasting, with proprietary AI and no named provider; they are also the segment of industrial vision and robotics (19%: fire-sensing cameras, autonomous mobile robots). Risk Listers have six activities at the median: some automation (21%) and some model (27%), almost always without product, metric or provider, and three in five never scale anything.

| | Product Deployers | Governance Adopters | Risk Listers |
|---|---:|---:|---:|
| Activities per firm (median) | **108** | 19.5 | 6 |
| deploy · AI product or service | 96 | 52 | 32 |
| deploy · named product or platform | **90** | 38 | 17 |
| deploy · analytics or data platform | 82 | 45 | 20 |
| deploy · ML or predictive model | 78 | 46 | 27 |
| deploy · automation | 65 | 39 | 21 |
| invest · compute and infrastructure | **61** | 16 | 7 |
| deploy · copilot or assistant | 43 | 18 | 6 |
| hire or train · talent | 56 | 26 | 16 |
| Customer-facing deployment (any) | **100** | 71 | 45 |
| Named third-party provider (any) | **90** | 53 | 32 |
| Quantified outcome (any) | **90** | 62 | 27 |
| Share of activities aimed at customers / internal (mean) | 45 / 35 | 25 / 58 | 18 / 62 |
| Highest stage reached is "scaled" | 93 | 61 | 32 |

: Disclosed AI activities by segment: % of the segment's firms with at least one activity of each type. {#tbl-activities-seg}

Firm inventories make the difference concrete. **Microsoft** (950 activities) deploys copilots (Copilot, GitHub Copilot, Microsoft 365 Copilot; 154 activities, 96% with a named product) for customers and employees, invests in and scales AI infrastructure and compute capacity (163) with OpenAI named as partner, deploys Azure OpenAI and Azure AI to customers, hires AI and responsible-AI talent, and attaches a number to one activity in five. **ServiceNow** (418) deploys Now Assist and AI agents for operations and customer service, a text-to-code tool for developers, and integrates AI with Accenture, Deloitte, EY and KPMG. **HPE** (385) ships AI servers and Private Cloud AI with NVIDIA, and GreenLake as the platform. **Etsy** (172) runs search algorithms, a recommendation engine and machine translation for buyers and sellers, uses third-party foundation models, and hires ML engineers. **Paychex** (163) deploys labour-forecasting models, a retention-insights tool and a recruiting copilot for HR clients.

**JPMorgan** (53) deploys "AI/ML" in fraud, risk and operations, inward, at scale, and in twenty such statements names no product, metric or provider; it invests in "AI/ML capabilities" and hires talent. **State Street** (30) runs quantitative models in operations and fraud, automates NAV calculation and fund accounting, and reports productivity metrics. **Cincinnati Financial** (25) builds underwriting and pricing models and has appointed a director with AI skills. **Danaher** (25) uses Microsoft Copilot for software development, an AI immunoassay analyser, and digital pathology with Indica Labs. **Lowe's** (19) pilots generative AI in operations, deploys a virtual advisor, and explores with NVIDIA, OpenAI and Palantir.

**Bank of America** (63) is the atypical Risk Lister: Erica, a virtual financial assistant and an advisor-insights tool for customers, predictive language models for fraud, and explicit model-risk governance; the segment is defined by the share of risk language in the filing, not by the absence of activity. **Nike** (28) scales machine-learning applications in operations and marketing, runs a search model and an insights model, and bought the Datalogue platform. **Comerica** (3) has a real-time payments system and mobile cheque scanning. **Howmet** (3) says "AI" and "AI in tests". **TransDigm** (1) is exploring process and test automation.
...
Among the 170 high-voice firms there are two populations. 142 describe at least one deployed activity with a named product (median 52 activities; R&D 10% of sales, beta 0.93, 2.4 AI frames per 1,000 paragraphs: NVIDIA, Microsoft, Adobe, Alphabet, IBM, Intel, Salesforce, Palo Alto Networks). 28 describe none (median 3 activities; R&D 1.7%, beta 0.77, 0.28 frames per 1,000: Colgate, American Water, Bristol Myers, American Airlines, PVH, Diamondback, Mohawk). The second population is the one that matches the intuitive notion of washing: strategic claims with no identifiable activity behind them. The decoupled corner itself is not homogeneous: 19 of its 36 firms have a deployed activity with a name (Apple, UnitedHealth, Elevance, PayPal, Cigna, Discover, U.S. Bancorp), 17 do not (Textron, Rollins, ONEOK, CSX, General Mills, Hilton, ConocoPhillips, Kimberly-Clark, Mondelez, KeyCorp). Concreteness is what splits it.
...
| Idiosyncratic volatility | +0.025 | +0.039 | **+0.044** | +0.019 | +0.004 | <0.001 | 0.022 | 0.821 |
| Price / sales | +0.027 | +0.024 | **+0.043** | +0.016 | +0.019 | 0.031 | 0.124 | 0.019 |
| R&D / sales | +0.021 | +0.026 | **+0.041** | +0.020 | +0.015 | 0.002 | 0.003 | 0.056 |
| Revenue growth t+1 | +0.023 | +0.027 | **+0.040** | +0.017 | +0.013 | 0.069 | 0.082 | 0.163 |
...
Both blocks carry signal, and they carry different signal: together they raise the increment to four to five points, and each keeps half or more of its own increment once the other is in. The exception is idiosyncratic volatility, where identifiable activity absorbs almost all of the style (semantics given activities +0.004, p = 0.82): idiosyncratic risk responds to what the firm does, not to how it tells it. For beta and price-to-sales, style holds up better given activity. The reading for H1 is that specificity matters in addition to activity, not instead of it.

## Reading for the thesis

The semantic parsing produces a coherent disclosure taxonomy (Chapter 4) and, in addition, incremental economic signal: two to four points of partial R² over fundamentals and volume on idiosyncratic risk, valuation, R&D and growth, concentrated in the specificity of the claims, and surviving adjusted R², a joint cluster-robust Wald test and a permutation within sector and year. Decomposed, the signal comes both from identifiable disclosed activity and from the style in which it is documented; for idiosyncratic risk, from the activity. It is a signal of *type of firm* more than of *change within the firm*. The result would have supported the thesis with any sign: had the increment been zero, the conclusion would have been "taxonomy yes, economic signal no". It came out positive and small, and that is what is written.
...
Does the call only change the tone, or also what the firm says it is doing? The disclosed activities answer that within the same firm and fiscal year, on the 464 cells of 182 firms with at least three activities in each venue: the share of the venue's activities in each family, call minus filing (@tbl-activity-gap, @fig-activity-gap).

| Activity family | Call | Filing | Gap (pp) | t |
|---|---:|---:|---:|---:|
| Customer-facing deployment | 37.8 | 37.3 | +0.5 | 0.4 |
| Internal deployment | 26.5 | 25.1 | +1.4 | 1.2 |
| Infrastructure investment | 6.8 | 8.0 | −1.2 | −1.6 |
| **Quantified outcome** | **11.5** | **4.4** | **+7.0** | 10.1 |
| **Named business function** | **76.6** | **65.9** | **+10.7** | 8.6 |
| Proprietary AI | 52.2 | 44.1 | +8.2 | 5.9 |
| Named product or process | 41.6 | 36.8 | +4.8 | 3.8 |
| Named third-party provider | 12.7 | 8.6 | +4.1 | 4.8 |
| Piloting or exploring | 4.4 | 2.3 | +2.1 | 4.6 |
| Talent or training | 1.2 | 2.8 | −1.6 | −4.8 |
| Governance or restriction | 0.3 | 1.8 | −1.5 | −5.8 |

: What the same firm says it does with AI on the call and in its filings, same fiscal year: share of the venue's activities in each family, 464 cells, 182 firms. {#tbl-activity-gap}
...
The mix of activities is the same in both venues: the shares of customer-facing deployment, internal deployment and infrastructure do not differ (gaps of −1 to +1.4 points, none distinguishable from zero). What changes is the evidence and the detail. On the call the same activity comes with a business function (+10.7 points), a quantified result (+7.0: the filing almost never puts the figure), a named product (+4.8) and a named provider (+4.1), and the firm claims the AI as its own (+8.2). The filing keeps talent and governance. Read in activities, the cross-venue gap is not "different things to different audiences" but "the same things, with numbers and names for the analyst and without them in what is signed". It is stable by year: the quantified-outcome gap runs between +4.5 and +8.4 points from 2021 to 2025, and the named-product gap grows from −1.4 to +10.4.
...
The disclosed activities separate promotional intensity from behavioural grounding. The eight flagged firms have between 110 and 727 activities and between 38 and 302 deployed activities with a named product or process (Alphabet 302, Palo Alto Networks 271, Cadence 184, Salesforce 182, CrowdStrike 166); their behavioural concreteness (0.37–0.52) sits in the upper half of the corpus. Promotional excess is uncorrelated with concreteness (Spearman −0.05, n = 437) and with the number of grounded activities (−0.04). In the top quintile of promotional rate, 84 of 90 firms have a deployed activity with a named product; the six that do not (PVH, PACCAR, Carnival, ConocoPhillips, LyondellBasell) have three activities at the median. Promoting and describing concrete activity go together; the excess the test detects is promotion on top of a lot of conduct, not promotion without conduct. Promotion without identifiable activity exists, but it is another population, the 28 high-voice firms without a grounded activity of Chapter 4, which this test does not flag because they have too few frames.
