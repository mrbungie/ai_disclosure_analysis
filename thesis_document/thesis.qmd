...
Each research question carries a distinct expected outcome under the theoretical mechanisms motivating it:

- **RQ1** expects AI language to spread broadly across the market while disclosed, verifiable operational activity grows more slowly than narrative volume, consistent with institutional pressure to adopt AI terminology regardless of underlying adoption.
- **RQ2** expects a small number of stable, economically coherent archetypes, with communication posture predicting disclosed activity and firm outcomes beyond narrative volume alone.
- **RQ3** expects promotional language to run ahead of grounded evidence more in earnings calls than in statutory filings, with SEC comment-letter scrutiny narrowing that gap.
- **RQ4** expects capital markets to price grounded operational substance rather than narrative volume alone, if signalling rather than cheap talk dominates corporate AI communication.
