...
Through the signaling lens [@spence1973; @verrecchia1983], the three archetypes sit on a proprietary-and-litigation-cost curve: Vocal Substantives' Item 1/MD&A claims must be backed by verifiable technical detail under Rule 10b-5; Governance-Led Disclosers direct communication toward DEF 14A, where supervisors and institutional investors price fiduciary process, not product capability [@suchman1995]; Defensive Disclosers use Item 1A boilerplate, a safe harbor satisfying disclosure expectations without commitment. This matches the sectoral sorting established earlier: Technology, whose products are their own evidence, sorts Vocal; regulated sectors sort Governance-Led; the rest sort Defensive or No AI -- AI as an exposure to manage rather than a claim worth proving.

It also explains the annual dynamics of @fig-archetype-composition-annual, read from the 2025-2026 transition once the taxonomy has settled. Institutional pressure compels firms to mention AI at all [@meyer1977, pp. 340--41; @dimaggio1983, pp. 147--48]; signaling cost explains why they land in Defensive rather than Vocal Substantives (`{python} f"{_row_pct2526.loc['No AI', 'Defensive Disclosers']:.1f}"`% vs. `{python} f"{_row_pct2526.loc['No AI', 'Vocal Substantives']:.1f}"`% of 2025 non-disclosers) -- a Vocal claim is costly to fabricate on short notice, boilerplate is not. The same logic covers the within-firm drift from Vocal to Defensive (`{python} f"{_row_pct2526.loc['Vocal Substantives', 'Defensive Disclosers']:.1f}"`% in 2025-2026, against `{python} f"{_row_pct2526.loc['Vocal Substantives', 'Vocal Substantives']:.1f}"`% persistence): sustaining a Vocal register is a recurring cost a firm can stop paying, retreating to boilerplate without its underlying AI program having changed.
