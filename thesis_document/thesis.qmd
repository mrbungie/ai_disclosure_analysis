...
The segmentation says that Product Deployers devote more of their AI statements to deployment and outcomes; it does not say what they deploy. A second, narrower pass of the language model over the 17,420 paragraphs that carry a firm-subject behavioural frame (deployment, piloting, scaling, capabilities, infrastructure, talent, investment, or an outcome) turns each such statement into a *disclosed AI activity*: the firm performs an action (deploy, develop, integrate, buy or license, partner, invest in infrastructure, hire or train, pilot, scale, measure an outcome, govern, restrict) on an object (a copilot, a fraud model, a data centre) for a function (customer service, software development, underwriting), with a target (customers, employees, an internal process), a stage, a named provider where there is one, and the strength of the evidence attached (a named product or process, a metric, a vendor, or none). Objects and functions are free text normalised afterwards into families, so that no ontology had to anticipate every use case. Each activity is counted once per firm. The pass yields 27,468 activities for 471 of the 510 firms; 48% of them appear only on earnings calls. As throughout, these are activities the firm *says* it performs, with the supporting sentences as evidence.

Six in ten activities are deployments and three in four are declared deployed or scaled: the register is one of use, not exploration. But the typical activity is thin. Almost a third names no business function, 46% attach no product, metric or vendor, and providers are almost never named: 88% of activities are "proprietary" or unspecified, and OpenAI/Microsoft, NVIDIA and Google together account for under 4%. Firms say what they do with AI far more than what they do it with.

| Type of disclosed activity | % of 510 firms | Filings only |
|---|---:|---:|
| Internal deployment (employees or processes) | 84.5 | 76.1 |
| Proprietary AI (develops, or states its own) | 78.2 | 66.1 |
| Names a product, system or process | 74.9 | 59.6 |
| Customer-facing deployment | 67.8 | 54.7 |
| Infrastructure investment | 55.7 | 40.0 |
| Quantified outcome | 55.7 | 34.9 |
| Named third-party provider | 53.3 | 38.8 |
| Piloting or exploring | 52.4 | 30.8 |
| Talent or training | 35.3 | 30.2 |
| Partnership with an AI provider | 31.4 | 18.4 |
| Governance or restriction of use | 28.2 | 25.3 |
| Acquisition or licensing | 16.5 | 12.7 |
| Developer tools | 8.0 | 5.3 |

: Top disclosed AI activities of the S&P 500: share of firms with at least one activity of each type, filings and calls pooled, and filings only. {#tbl-top-activities}

The activity layer gives the segments tangible content (@tbl-activities-seg). Product Deployers do everything, and do it with names and numbers: every one of them deploys customer-facing AI, 92% invest in infrastructure, 90% name a provider and 90% report a quantified result; half acquire or license and two-thirds partner; their median firm has 108 activities. Governance Adopters deploy mostly inward (58% of their activities are internal), in operations, fraud and risk, with proprietary AI and no named provider; a third pilot or train. Risk Listers have six activities at the median, three in five never scale anything, and what little they describe is internal deployment in operations with no product, metric or provider attached. The functions differ less than the depth: operations and supply chain lead in every segment; IT, cybersecurity and software development are heavier among Deployers, fraud and risk among Adopters.

| | Product Deployers | Governance Adopters | Risk Listers |
|---|---:|---:|---:|
| Activities per firm (median) | **108** | 19.5 | 6 |
| Customer-facing deployment | **100** | 71 | 45 |
| Internal deployment | 97 | 88 | 78 |
| Proprietary AI | 99 | 86 | 59 |
| Named third-party provider | **90** | 53 | 32 |
| Infrastructure investment | **92** | 57 | 33 |
| Quantified outcome | **90** | 62 | 27 |
| Piloting or exploring | 78 | 55 | 35 |
| Partnership | 68 | 28 | 13 |
| Talent or training | 66 | 33 | 20 |
| Acquisition or licensing | 50 | 8 | 6 |
| Governance or restriction | 49 | 29 | 15 |
| Developer tools | 29 | 2 | 2 |
| Share of activities aimed at customers (mean) | 45 | 25 | 18 |
| Share of activities internal (mean) | 35 | 58 | 62 |
...
Firm cards make the difference concrete. **Microsoft** (950 activities) integrates generative AI into customer-facing products, deploys copilots in internal workflows, invests in AI infrastructure and compute capacity, relies on OpenAI and Azure, and attaches a number to one activity in five. **ServiceNow** (418) deploys and integrates AI agents and a platform for operations and customer service, with Now Assist and NVIDIA named. **Etsy** (172) applies machine-learning and large-language models to search and content, 61% of it customer-facing. **JPMorgan** (53) deploys mostly inward (60%), in operations and fraud, with proprietary AI, and almost never names a product (4%) or a figure (6%); **State Street** (30) is the same profile at 73% internal; **Cincinnati Financial** (25) builds underwriting and pricing models and reports a director with AI skills. **Nike** (28) describes internal machine-learning applications in operations and marketing; **Howmet** and **TransDigm** offer one to three sentences about test automation. **Bank of America** (63 activities, Erica, explicit governance) is the atypical Risk Lister, which shows that the segment is defined by the share of risk language in the filing, not by the absence of activity.
