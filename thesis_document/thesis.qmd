...
# Ternary-specific subpalette: the three vertices are semantic poles, not
# categories, so they get a dedicated, more separable triad -- teal / rust /
# slate-indigo, equalized in lightness and saturation for visual parity --
# rather than the document's restrained editorial palette used elsewhere.
POLE_VOCAL, POLE_GOV, POLE_DEF = "#2A8479", "#554D89", "#AB5A3F"

ax.text(0.33, 0.06, "Pure Vocal (w > 0.5)", fontsize=7.2, color=POLE_VOCAL, ha="center", style="italic")
ax.text(0.67, 0.06, "Pure Governance (w > 0.5)", fontsize=7.2, color=POLE_GOV, ha="center", style="italic")
ax.text(0.50, 0.60, "Pure Defensive (w > 0.5)", fontsize=7.2, color=POLE_DEF, ha="center", style="italic")
...
ax.text(-0.05, -0.07, "Vocal Substantives\n(Commercial Execution)",
        fontsize=11, fontweight="bold", ha="center", va="top", color=POLE_VOCAL)
ax.text(1.05, -0.07, "Governance-Led Disclosers\n(Institutional Guardrails)",
        fontsize=11, fontweight="bold", ha="center", va="top", color=POLE_GOV)
ax.text(0.5, np.sqrt(3)/2 + 0.05, "Defensive Disclosers\n(Risk-Framed)",
        fontsize=11, fontweight="bold", ha="center", va="bottom", color=POLE_DEF)

# Vertex markers themselves, so the three poles read as distinct anchors
# even before the eye reaches the corner labels.
for (vx, vy), vc in [((0, 0), POLE_VOCAL), ((1, 0), POLE_GOV), ((0.5, np.sqrt(3)/2), POLE_DEF)]:
    ax.scatter([vx], [vy], color=vc, s=170, edgecolor="white", linewidth=1.6, zorder=11)
